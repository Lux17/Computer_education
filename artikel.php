    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="nav-item">
            <a class="nav-link" style="color: #348A0C;" href="index.php#sejarah">Sejarah</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" style="color: #348A0C;" href="index.php#divisi">Divisi</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" style="color: #348A0C;"  href="index.php#galeri">Galeri</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" style="color: #348A0C;" href="index.php#pengurus">Pengurus</a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" style="color: #348A0C;" href="index.php#artikel">Artikel</a>
          </li>
