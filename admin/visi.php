        ...
        <div class="modal-dialog" role="document">
            ...
            <form method="POST" action="ketum/tambah_visi.php" enctype="multipart/form-data" >
                        <section class="base align-items-center ">
                            <div>
                            <label >Visi </label>
                            <input type="text" name="visi" autofocus="" required="" />
                            </div>
                            <div>
                            <label> Misi</label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary">Save changes</button>
                    ...
                    <tr>
                        ...
                        <td  scope="row">Rp <?php echo $row['misi']; ?></td>
        ...
        <div class="modal-dialog" role="document">
            ...
            <form method="POST" action="ketum/edit_visi.php" enctype="multipart/form-data" >
                        ...
                        <div>
                            ...
                            <div>
                            <label >Bulan </label>
                            <input type="text" value="<?php echo $row['visi']; ?>" name="visi" autofocus="" required="" />
                            </div>
                            <div>
                            <label> Jumlah Kas </label>
                            <input type="text" value="<?php echo $row['misi']; ?>"  name="misi" required="" />
                            </div>
