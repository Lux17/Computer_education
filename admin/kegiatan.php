        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">List Kegiatan Computer Education.</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-success">Data Tabel Kegiatan</h6>
                    </div>
...
<!-- Modal -->
        ...
        <div class="modal-dialog" role="document">
            ...
            <form method="POST" action="kegiatan/tambah_kegiatan.php" enctype="multipart/form-data" >
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
            <form method="POST" action="kegiatan/edit_kegiatan.php" enctype="multipart/form-data" >
            ...
            <div class="modal-footer">
                ...
                <button type="submit"  class="btn btn-primary">Simpan</button>
                                        ...
                                        |
                                            <a  href="kegiatan/hapus_kegiatan.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
                                        </td>
                                    </tr>
