        ...
        <div class="modal-dialog" role="document">
            ...
            <form method="POST" action="kas/tambah_kas.php" enctype="multipart/form-data" >
                        <section class="base align-items-center ">
                            <div>
                            <label >Bulan </label>
                            <input type="text" name="bulan" autofocus="" required="" />
                            </div>
                            <div>
        ...
        <div class="modal-dialog" role="document">
            ...
            <form method="POST" action="kas/edit_kas.php" enctype="multipart/form-data" >
                        ...
                        <div>
                            ...
                            <div>
                            <label >Bulan </label>
                            <input type="text" value="<?php echo $row['bulan']; ?>" name="bulan" autofocus="" required="" />
                            </div>
                            <div>
                            <label> Jumlah Kas </label>
                            <input type="text" value="<?php echo $row['jumlah_kas']; ?>"  name="jumlah_kas" required="" />
                            </div>
